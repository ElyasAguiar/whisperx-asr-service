...
class TestGRPCStructure(unittest.TestCase):
    ...
    def test_asr_config_defaults(self):
        ...
        self.assertEqual(
            config.diarization_model, "pyannote/speaker-diarization-community-1"
        )
    ...
    def test_encoding_string_conversion(self):
        ...
        try:
            ...
            # Test conversion
            linear_pcm = servicer._encoding_to_string(
                asr_pb2.RecognitionConfig.LINEAR_PCM
            )
...
class TestModelAbstraction(unittest.TestCase):
    ...
    def test_asr_config_creation(self):
        ...
        config = ASRConfig(
            language="es", model="medium", enable_diarization=False, num_speakers=3
        )
    ...
    def test_word_info_structure(self):
        ...
        word = WordInfo(
            word="hello", start=1.5, end=2.0, confidence=0.95, speaker="SPEAKER_00"
        )
    ...
    def test_segment_structure(self):
        ...
        segment = Segment(
            text="hello world", start=0.0, end=1.0, words=words, speaker="SPEAKER_00"
        )
