...
class AsrServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamingRecognize = channel.stream_stream(
                '/whisperx.asr.AsrService/StreamingRecognize',
        ...
        self.Recognize = channel.unary_unary(
                '/whisperx.asr.AsrService/Recognize',
...
def add_AsrServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'whisperx.asr.AsrService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('whisperx.asr.AsrService', rpc_method_handlers)
