...
class RecognitionConfig(_message.Message):
    __slots__ = ("encoding", "sample_rate_hertz", "audio_channel_count", "language_code", "max_alternatives", "model", "enable_automatic_punctuation", "enable_speaker_diarization", "diarization_speaker_count", "min_speaker_count", "max_speaker_count", "enable_word_time_offsets", "task", "initial_prompt")
    ...
    task: str
    initial_prompt: str
    def __init__(self, encoding: _Optional[_Union[RecognitionConfig.AudioEncoding, str]] = ..., sample_rate_hertz: _Optional[int] = ..., audio_channel_count: _Optional[int] = ..., language_code: _Optional[str] = ..., max_alternatives: _Optional[int] = ..., model: _Optional[str] = ..., enable_automatic_punctuation: bool = ..., enable_speaker_diarization: bool = ..., diarization_speaker_count: _Optional[int] = ..., min_speaker_count: _Optional[int] = ..., max_speaker_count: _Optional[int] = ..., enable_word_time_offsets: bool = ..., task: _Optional[str] = ..., initial_prompt: _Optional[str] = ...) -> None: ...
...
class WordInfo(_message.Message):
    ...
    confidence: float
    speaker_tag: int
    def __init__(self, start_time: _Optional[float] = ..., end_time: _Optional[float] = ..., word: _Optional[str] = ..., confidence: _Optional[float] = ..., speaker_tag: _Optional[int] = ...) -> None: ...
...
class SpeechRecognitionResult(_message.Message):
    ...
    def __init__(self, alternatives: _Optional[_Iterable[_Union[SpeechRecognitionAlternative, _Mapping]]] = ..., channel_tag: _Optional[int] = ..., language_code: _Optional[str] = ..., audio_processed: _Optional[float] = ...) -> None: ...
...
class StreamingRecognitionResult(_message.Message):
    __slots__ = ("alternatives", "is_final", "stability", "channel_tag", "language_code")
    ALTERNATIVES_FIELD_NUMBER: _ClassVar[int]
    ...
    channel_tag: int
    language_code: str
    def __init__(self, alternatives: _Optional[_Iterable[_Union[SpeechRecognitionAlternative, _Mapping]]] = ..., is_final: bool = ..., stability: _Optional[float] = ..., channel_tag: _Optional[int] = ..., language_code: _Optional[str] = ...) -> None: ...
